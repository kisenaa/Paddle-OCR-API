...
def text_visual(
    ...
    def create_blank_img():
        blank_img = np.full((img_h, img_w), 255, dtype=np.uint8)
        blank_img[:, img_w - 1 :] = 0
...
def infer_args():
    ...
    parser.add_argument(
        "--det_model_file",
        type=str,
        default=str(module_dir / "models/v5_server_detection.xml"),
    )
    parser.add_argument(
        "--det_model_weights",
        type=str,
        default=str(module_dir / "models/v5_server_detection.bin"),
    )
    ...
    parser.add_argument(
        "--rec_model_file",
        type=str,
        default=str(module_dir / "models/v5_server_recognition.xml"),
    )
    parser.add_argument(
        "--rec_model_weights",
        type=str,
        default=str(module_dir / "models/v5_server_recognition.bin"),
    )
    parser.add_argument("--rec_image_inverse", type=str2bool, default=True)
    parser.add_argument("--rec_image_shape", type=str, default="3, 48, 1280")
    ...
    # params for text classifier - unused as of now
